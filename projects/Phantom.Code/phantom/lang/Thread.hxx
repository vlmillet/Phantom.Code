...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Thread")
        ...
        .protected_()
            ...
            // .constructor<void(StringView, ::std::thread::id)>()
        ...
        .public_()
            ...
            /// missing symbol(s) reflection (std::function) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .method<void(const ::std::function<bool ()> &)>("setTickCallback", &_::setTickCallback)
            ...
            // .method<void(const ::std::future<void> &)>("pushCall", &_::pushCall)
            /// missing symbol(s) reflection (std::function) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .method<void(const ::std::function<void ()> &)>("pushCall", &_::pushCall)
            /// missing symbol(s) reflection (std::function) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .method<void(const ::std::function<void ()> &)>("pushCallAndWait", &_::pushCallAndWait)
            .method<void(ThreadGroup*)>("setGroup", &_::setGroup)
            .method<ThreadGroup*() const>("getGroup", &_::getGroup)
            .method<void(int)>("sleepMs", &_::sleepMs)
