...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Project")
        ...
        .public_()
            .constructor<void(Solution*, StringView, Module*)>()
            .method<bool(ProjectData)>("setData", &_::setData)
            ...
            .method<Package*(SourceStream*) const>("getPackageForSourceStream", &_::getPackageForSourceStream)
            .method<SourceFile*(StringView) const>("getSourceFileByPath", &_::getSourceFileByPath)
            ...
            .method<SourceFile*(StringView, StringView)>("addSourceFile", &_::addSourceFile)["\"\""]
            .method<bool(SourceFile*)>("addSourceFile", &_::addSourceFile)
            .method<void(SourceFile*)>("removeSourceFile", &_::removeSourceFile)
            .method<bool() const>("isPathExisting", &_::isPathExisting)
            .method<bool(Project*) const>("hasProjectDependencyCascade", &_::hasProjectDependencyCascade)
            .method<CompiledSources() const>("getCompiledSources", &_::getCompiledSources)
            .method<void(CompiledSources&) const>("getCompiledSources", &_::getCompiledSources)
