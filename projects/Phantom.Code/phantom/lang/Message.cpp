...
Message::Message(MessageType a_eType, StringView a_strText) : m_strText(a_strText), m_eType(a_eType), m_pParent(nullptr)
{
}
...
{
    Message* cloned = new_<Message>(m_eType, m_strText);
...
{
    Message* pMessage = new_<Message>(a_eType);
