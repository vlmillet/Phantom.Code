...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("WStringLiteralExpression")
        ...
        .public_()
            ...
            // .constructor<void(StringView, const ::std::wstring &)>()({"a_Literal","a_Value"})
            ...
            .method<::phantom::lang::WStringLiteralExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
