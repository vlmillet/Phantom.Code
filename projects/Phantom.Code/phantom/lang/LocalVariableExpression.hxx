...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("LocalVariableExpression")
        ...
        .public_()
            ...
            .constructor<void(LocalVariable*)>()
            .method<void()>("initialize", &_::initialize)
            .method<LocalVariable*() const>("getLocalVariable", &_::getLocalVariable)
            .method<::phantom::lang::LocalVariableExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)
        ...
        .protected_()
            .method<void*(ExecutionContext&) const, virtual_>("internalEvalAddress", &_::internalEvalAddress)
