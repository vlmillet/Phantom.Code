...
{
template<class T>
void PHANTOM_LANG_CPPLITEGRAMMAR_DTOR(T* p)
{
    p->~T();
}
} // namespace
...
#define PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(...)                                                                        \
    if (__VA_ARGS__)                                                                                                   \
    {                                                                                                                  \
        PHANTOM_LANG_CPPLITEGRAMMAR_DTOR(__VA_ARGS__);                                                                 \
        m_Allocator.deallocate(__VA_ARGS__, sizeof(__VA_ARGS__));                                                      \
    }
static const char* g_TokenPrettyNames[] = {"<error>",
                                           "::",
                                           "{",
                                           "}",
                                           "(",
...
union RuleUnion {
    ...
    TypeNoFunctionType                m_TypeNoFunctionType;
    ExplicitTypeNoFunctionType        m_ExplicitTypeNoFunctionType;
...
struct CppLiteGrammarPrivate
{
    ...
    bool token(EToken t, size_t tokenPointer) { return m_Tokens[tokenPointer].id == t; }
    bool token(EToken t) { return m_Tokens[m_TokenPointer].id == t; }
    bool token(std::initializer_list<EToken> const& ts)
    {
        for (auto t : ts)
            if (m_Tokens[m_TokenPointer].id == t)
                return true;
        return false;
    }
    ...
    bool lookahead(EToken token) { return lookahead({token}); }
    ...
    void valueAs(T& buf)
    {
        m_Tokens[m_TokenPointer].value.as(buf);
    }
    template<class T>
    ...
    bool checkTokenContiguous(size_t tokenPointer)
    {
        ...
        if (newLoc.begin.line != prevLoc.end.line || newLoc.begin.column != prevLoc.end.column)
        {
            return errorUnexpected(newLoc, token(tokenPointer));
        }
        return true;
    }
    bool checkNextTokenContiguous() { return checkTokenContiguous(m_TokenPointer); }
    bool readContiguous(EToken t) { return checkNextTokenContiguous() && read(t); }
    template<class T>
    ...
    bool consume()
    {
        ...
        if (m_TokenPointer >= m_Tokens.size())
        {
            ...
            {
                return error(m_TokenPointer == 0 ? spell::Location() : m_Tokens[m_TokenPointer - 1].location,
    ...
    void beginTry()
    {
        ...
        {
            m_Tries[m_TryPointer].m_Success = true;
            m_Tries[m_TryPointer].m_StartTokenPointer = m_TokenPointer;
        }
    }
    ...
    {
        const char* errorMsg = "";
        if (code > e_ErrorOK && code < e_Error_UnexpectedToken)
            errorMsg = "expected token ";
        else if (code > e_Error_UnexpectedToken && code < e_Error_Count)
          ...
          m_Allocator(a_Allocator)
    {
        ...
        m_Lexer.addRule(spell::Lexer::as_float(),
                        "(([0-9]+\\.[0-9]*([eE][-+]?[0-9]+)?)|(\\.[0-9]+([eE][-+]?[0-9]+)?))f", token_FLOAT_VALUE);
        m_Lexer.addRule(spell::Lexer::as_double(),
                        "(([0-9]+\\.[0-9]*([eE][-+]?[0-9]+)?)|(\\.[0-9]+([eE][-+]?[0-9]+)?))", token_DOUBLE_VALUE);
    ...
    bool readSource(Source*& output)
    {
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_ModuleDeclarations == nullptr)
                    __element__->m_ModuleDeclarations =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::ModuleDeclaration*, 4ull>);
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_ImportDeclarations == nullptr)
                    __element__->m_ImportDeclarations =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::ImportDeclaration*, 4ull>);
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_SourceDeclarations == nullptr)
                    __element__->m_SourceDeclarations =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::SourceDeclaration*, 4ull>);
        ...
        output->__location.end =
        (m_Tokens.size() > 1) ? m_Tokens[m_Tokens.size() - 2].location.end : m_Tokens.back().location.end;
        return true;
    }
    bool readModuleDeclaration(ModuleDeclaration*& output)
    {
        ...
        if (!read(token_IDENTIFIER, temp3))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readImportDeclaration(ImportDeclaration*& output)
    {
        ...
        if (lookahead(token_IMPORT))
        {
            ...
            __element__->m_Imports =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Import*, 4ull>);
        ...
        else
        {
            ...
            {
                if (!read(token_LT, __element__->m_LT))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
                ...
                if (!read(token_IDENTIFIER, temp5))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
                ...
                if (!read(token_GT, __element__->m_GT))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            {
                if (!read(token_STRING_LIT, __element__->m_STRING_LIT))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readImport(Import*& output)
    {
        ...
        if (!readImportBase(__element__->m_ImportBase))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_COLON)
        {
            ...
            consume();
            __element__->m_ImportBindings =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::ImportBinding*, 4ull>);
            phantom::lang::ast::ImportBinding* temp6 = nullptr;
            if (!readImportBinding(temp6))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readImportBinding(ImportBinding*& output)
    {
        ...
        bool            __reductible__ = true;
        if (!read(token_IDENTIFIER, __element__->m_IDENTIFIER))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_ASSIGN)
        {
            ...
            consume();
            if (!read(token_IDENTIFIER, __element__->m_IDENTIFIER0))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readImportBase(ImportBase*& output)
    {
        ...
        {
            if (!read(token_IDENTIFIER, __element__->m_Alias))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!read(token_ASSIGN, __element__->m_ASSIGN))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            ...
            if (!read(token_IDENTIFIER, temp7))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        else
        {
            ...
            if (!read(token_IDENTIFIER, temp8))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readMeta(Meta*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        __element__->m_MetaDecls =
        PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::MetaDecl*, 4ull>);
        phantom::lang::ast::MetaDecl* temp9 = nullptr;
        if (!readMetaDecl(temp9))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readMetaDecl(MetaDecl*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_BRACKET_START))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!read(token_STRING_LIT, __element__->m_Key))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_ASSIGN)
        {
            valueAs(__element__->m_ASSIGN);
            consume();
            if (!readAssignExpression(__element__->m_Value))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readMetaOrAnnotation(MetaOrAnnotation*& output)
    {
        ...
        {
            if (!readAnnotation(__element__->m_Annotation))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readSourceDeclaration(SourceDeclaration*& output)
    {
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_MetaOrAnnotations == nullptr)
                    __element__->m_MetaOrAnnotations =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::MetaOrAnnotation*, 4ull>);
        ...
        if (!readDeclaration(__element__->m_Declaration))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readDeclaration(Declaration*& output)
    {
        ...
        case token_STRUCT:
        {
            if (!readClass(__element__->m_Class))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ENUM:
        {
            if (!readEnum(__element__->m_Enum))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_USING:
        {
            ...
            {
                if (!readUsing(__element__->m_Using))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
        ...
        case token_TYPEDEF:
        {
            if (!readTypedef(__element__->m_Typedef))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_TEMPLATE:
        {
            if (!readTemplate(__element__->m_Template))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ATAT:
        {
            if (!readMixinStatementDefinition(__element__->m_MixinStatementDefinition))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readStaticAssert(__element__->m_StaticAssert))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readFunctionOrVariable(__element__->m_FunctionOrVariable))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readMixinStatementDefinition(MixinStatementDefinition*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_ATAT, __element__->m_ATAT))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (!read(token_PAREN_START, __element__->m_PAREN_START))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (endTry())
        {
            ...
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                ...
                if (!read(token_IDENTIFIER, temp12))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
        ...
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!read(token_BLOCK_START))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_Statements == nullptr)
                    __element__->m_Statements =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Statement*, 4ull>);
    ...
    bool readBlockDeclaration(Statement*& output)
    {
        ...
        break;
        default:
            if (!readAlias(__element__->m_Alias0))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readConversionFunction(ConversionFunction*& output)
    {
        ...
        {
            valueAs(__element__->m_EXPLICIT);
            consume();
        }
        if (!read(token_OPERATOR))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readTypeNoFunctionType(__element__->m_TypeNoFunctionType))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (!readFunctionBlock(__element__->m_FunctionBlock))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readConstructor(Constructor*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_Parameters =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Parameter*, 4ull>);
            __element__->m_Parameters->push_back(temp16);
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                consume();
                phantom::lang::ast::Parameter* temp17 = nullptr;
                if (!readParameter(temp17))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp16);
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
        ...
        if (lookahead(token_ASSIGN))
        {
            ...
            if (!read(token_ASSIGN, temp18))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!read({token_DELETE, token_DEFAULT}, __element__->m_Suffix))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        else
        {
            ...
            {
                consume();
                __element__->m_ConstructorInitializers = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                phantom::SmallVector<phantom::lang::ast::ConstructorInitializer*, 4ull>);
                phantom::lang::ast::ConstructorInitializer* temp19 = nullptr;
                if (!readConstructorInitializer(temp19))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readDestructor(Destructor*& output)
    {
        ...
        if (!read(token_COMPL, __element__->m_COMPL))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readConstructorInitializer(ConstructorInitializer*& output)
    {
        ...
        bool                     __reductible__ = true;
        if (!readBasicType(__element__->m_BasicType))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        {
            if (!readCallList(__element__->m_CallList))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readInitializerList(__element__->m_InitializerList))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readArrowReturn(ArrowReturn*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_ARROW, __element__->m_ARROW))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readType(__element__->m_Type))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readFunctionEnd(FunctionEnd*& output)
    {
        ...
        if (endTry())
        {
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp21);
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
        ...
        if (lookahead({token_BLOCK_START, token_OVERRIDE, token_FINAL}))
        {
            while (!endOfFile())
            {
                ...
                {
                    if (__element__->m_OVERRIDEs == nullptr)
                        __element__->m_OVERRIDEs =
                        PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<spell::any, 4ull>);
        ...
        else
        {
            ...
            if (!read(token_ASSIGN, temp26))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!read({token_INT_VALUE, token_DELETE, token_DEFAULT}, __element__->m_Suffix))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readOperator(Operator*& output)
    {
        ...
        case token_PAREN_START:
        {
            ...
            if (!read(token_PAREN_START, (*__element__->m_OpParen)[0]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!readContiguous(token_PAREN_END, (*__element__->m_OpParen)[1]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_BRACKET_START:
        {
            ...
            if (!read(token_BRACKET_START, (*__element__->m_OpBracket)[0]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!readContiguous(token_BRACKET_END, (*__element__->m_OpBracket)[1]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_GT:
        {
            ...
            {
                __element__->m_RightShiftAssign =
                PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<spell::any, 4ull>)(2);
                if (!read(token_GT, (*__element__->m_RightShiftAssign)[0]))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
                }
                if (!readContiguous(token_GE, (*__element__->m_RightShiftAssign)[1]))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            else
            {
                ...
                {
                    __element__->m_RightShift =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<spell::any, 4ull>)(2);
                    if (!read(token_GT, (*__element__->m_RightShift)[0]))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                    }
                    if (!readContiguous(token_GT, (*__element__->m_RightShift)[1]))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                ...
                {
                    if (!read(token_GT, __element__->m_GreaterThan))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
        ...
        break;
        default:
            if (!read({token_ASSIGN, token_ASS_ADD, token_ASS_AND, token_ASS_DIV, token_ASS_MOD, token_ASS_MUL,
                       token_ASS_OR, token_ASS_SHL, token_ASS_SUB, token_ASS_XOR, token_BIN_OR,  token_INC,
                       token_DEC,    token_MUL,     token_PLUS,    token_MINUS,   token_DIV,     token_EQ,
                       token_NE,     token_XOR,     token_SHL,     token_LT,      token_LE,      token_GE,
                       token_NOT,    token_ARROW},
                      __element__->m_ASSIGN))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readOperatorEnd(OperatorEnd*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!readOperator(__element__->m_Operator))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readFunctionEnd(__element__->m_FunctionEnd))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readFunctionOrVariableEnd(FunctionOrVariableEnd*& output)
    {
        ...
        case token_BRACKET_START:
        {
            __element__->m_ArrayExtents =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::TypeExtent*, 4ull>);
            phantom::lang::ast::TypeExtent* temp27 = nullptr;
            if (!readArrayExtent(temp27))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            ...
            {
                consume();
                if (!readAssignExpressionOrInitializerList(__element__->m_AssignExpressionOrInitializerList))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            {
                consume();
                __element__->m_Declarators =
                PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Declarator*, 4ull>);
                phantom::lang::ast::Declarator* temp28 = nullptr;
                if (!readDeclarator(temp28))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
        ...
        case token_LT:
        {
            if (!readTemplateArgumentList(__element__->m_TemplateArgumentList))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readMethodSpecifier(MethodSpecifier*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_STATIC, token_VIRTUAL}, __element__->m_STATIC))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readSpecifier(Specifier*& output)
    {
        ...
        bool        __reductible__ = true;
        if (!readMethodSpecifier(__element__->m_MethodSpecifier))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readFunctionOrVariable(FunctionOrVariable*& output)
    {
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_Specifiers == nullptr)
                    __element__->m_Specifiers =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Specifier*, 4ull>);
        ...
        if (token() == token_ALIGNAS)
        {
            ...
            if (!read(token_INT_VALUE, __element__->m_AlignAs))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        if (!readTypeOrAuto(__element__->m_TypeOrAuto))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        {
            if (!readOperatorEnd(__element__->m_OperatorEnd))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readFunctionOrVariableEnd(__element__->m_FunctionOrVariableEnd))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readDeclType(DeclType*& output)
    {
        ...
        if (!readExpression(__element__->m_Expression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLastTemplateArgumentAssign(LastTemplateArgument*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!readTemplateArgumentAssign(__element__->m_TemplateArgumentAssign))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLastTemplateArgumentNoAssign(LastTemplateArgument*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!readTemplateArgumentNoAssign(__element__->m_TemplateArgumentNoAssign))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLastTemplateArgument(TemplateArgument*& output)
    {
        ...
        {
            if (!readLastTemplateArgumentNoAssign(__element__->m_LastTemplateArgumentNoAssign))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readNotLastTemplateArgument(TemplateArgument*& output)
    {
        ...
        {
            if (!readNotLastTemplateArgumentNoAssign(__element__->m_NotLastTemplateArgumentNoAssign))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readTemplateArgumentListSplit(TemplateArgumentListSplit*& output)
    {
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_NotLastTemplateArguments == nullptr)
                    __element__->m_NotLastTemplateArguments =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::TemplateArgument*, 4ull>);
        ...
        if (!readLastTemplateArgument(__element__->m_LastTemplateArgument))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTemplateArgumentNoAssign(TemplateArgumentNoAssign*& output)
    {
        ...
        bool                       __reductible__ = true;
        if (!readPostFixExpression(__element__->m_PostFixExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTemplateArgumentAssign(TemplateArgumentAssign*& output)
    {
        ...
        bool                     __reductible__ = true;
        beginTry();
        read({token_INT_VALUE, token_UINT_VALUE, token_LONG_VALUE, token_ULONG_VALUE, token_LONG_VALUE,
              token_ULONGLONG_VALUE, token_HEX_VALUE},
             __element__->m_INT_VALUE);
        if (endTry())
        {
        }
        else
    ...
    bool readTemplateArgumentList(TemplateArgumentList*& output)
    {
        ...
        {
            if (!readTemplateArgumentListSplit(__element__->m_TemplateArgumentListSplit))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readFundamentalTypeBase(FundamentalTypeBase*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_BOOL, token_CHAR, token_SHORT, token_INT, token_LONG, token_FLOATING_POINT_TYPE},
                  __element__->m_Typename))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readUnsignedType(Type*& output)
    {
        ...
        bool   __reductible__ = true;
        if (!read(token_UNSIGNED, __element__->m_UNSIGNED))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readSignedType(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!read(token_SIGNED, __element__->m_SIGNED))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLongType(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!read(token_LONG, __element__->m_LONG))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readVoidType(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!read(token_VOID, __element__->m_VOID))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readFundamentalType(Type*& output)
    {
        ...
        case token_UNSIGNED:
        {
            if (!readUnsignedType(__element__->m_UnsignedType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_SIGNED:
        {
            if (!readSignedType(__element__->m_SignedType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_LONG:
        {
            if (!readLongType(__element__->m_LongType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_VOID:
        {
            if (!readVoidType(__element__->m_VoidType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readFundamentalTypeBase(__element__->m_FundamentalTypeBase))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readQualifiedType(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!readQualifiedName(__element__->m_QualifiedName))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTypeNoFunctionType(Type*& output)
    {
        m_LookaheadCounter = 0;
        auto __element__ = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(TypeNoFunctionType);
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        beginTry();
        readExplicitTypeNoFunctionType(__element__->m_ExplicitTypeNoFunctionType);
        __reduction__ = &__element__->m_ExplicitTypeNoFunctionType;
        if (endTry())
        {
        }
        else
        {
            if (!readExpressionType(__element__->m_ExpressionType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readExplicitTypeNoFunctionType(Type*& output)
    {
        m_LookaheadCounter = 0;
        auto __element__ = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(ExplicitTypeNoFunctionType);
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_TypeExtentNoFunctions == nullptr)
                    __element__->m_TypeExtentNoFunctions =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::TypeExtent*, 4ull>);
    ...
    bool readExpressionType(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!readAssignExpression(__element__->m_AssignExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readExplicitTypeOrAuto(Type*& output)
    {
        ...
        if (!readBasicTypeOrAuto(__element__->m_BasicTypeOrAuto))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readAutoType(Type*& output)
    {
        ...
        if (!readAuto(__element__->m_Auto))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readBasicType(Type*& output)
    {
        ...
        case token_VOID:
        {
            if (!readFundamentalType(__element__->m_FundamentalType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_DECLTYPE:
        {
            if (!readDeclType(__element__->m_DeclType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readQualifiedType(__element__->m_QualifiedType))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readAuto(Type*& output)
    {
        ...
        Type** __reduction__ = (Type**)&__element__;
        bool   __reductible__ = true;
        if (!read(token_AUTO, __element__->m_AUTO))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readIntegralConstant(Expression*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_INT_VALUE, token_UINT_VALUE, token_LONG_VALUE, token_ULONG_VALUE, token_LONGLONG_VALUE,
                   token_ULONGLONG_VALUE, token_BOOL_VALUE, token_CHAR_LIT, token_HEX_VALUE},
                  __element__->m_INT_VALUE))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readFunctionTypeExtent(TypeExtent*& output)
    {
        m_LookaheadCounter = 0;
        auto __element__ = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(FunctionTypeExtent);
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_PAREN_START, __element__->m_PAREN_START))
        {
        ...
        {
            __element__->m_Types =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Type*, 4ull>);
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp50);
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readDerivedExtent(TypeExtent*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_BIN_AND, token_LOG_AND, token_MUL, token_CONST, token_VOLATILE}, __element__->m_BIN_AND))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTypeExtentNoFunction(TypeExtent*& output)
    {
        m_LookaheadCounter = 0;
        auto __element__ = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(TypeExtentNoFunction);
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        ...
        case token_BRACKET_START:
        {
            if (!readArrayExtent(__element__->m_ArrayExtent))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readDerivedExtent(__element__->m_DerivedExtent))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readTypeExtent(TypeExtent*& output)
    {
        ...
        case token_PAREN_START:
        {
            if (!readFunctionTypeExtent(__element__->m_FunctionTypeExtent))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            __reduction__ = &__element__->m_FunctionTypeExtent;
        }
        break;
        default:
            if (!readDerivedExtent(__element__->m_DerivedExtent))
    ...
    bool readEnum(Enum*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_EnumConstants =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::EnumConstant*, 4ull>);
            __element__->m_EnumConstants->push_back(temp52);
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                consume();
                phantom::lang::ast::EnumConstant* temp53 = nullptr;
                if (!readEnumConstant(temp53))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp52);
        if (!read(token_BLOCK_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readTemplateTypeParameter(TemplateTypeParameter*& output)
    {
        ...
        if (!read({token_CLASS, token_TYPENAME}, temp55))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTemplateParameter(TemplateParameter*& output)
    {
        ...
        {
            if (!readTemplateTypeParameter(__element__->m_TemplateTypeParameter))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readTemplateSignature(TemplateSignature*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_TemplateParameters =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::TemplateParameter*, 4ull>);
            __element__->m_TemplateParameters->push_back(temp58);
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                consume();
                phantom::lang::ast::TemplateParameter* temp59 = nullptr;
                if (!readTemplateParameter(temp59))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readTemplate(Template*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!readTemplateSignature(__element__->m_TemplateSignature))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        case token_UNION:
        {
            if (!readUnion(__element__->m_Union))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_USING:
        {
            if (!readAlias(__element__->m_Alias))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        default:
            ...
            {
                if (!readConstructor(__element__->m_Constructor))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readQualifiedName(QualifiedName*& output)
    {
        ...
        {
            if (!readQualifiedDotName(__element__->m_Dot))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readQualifiedScopedName(QualifiedScopedName*& output)
    {
        ...
        {
            __element__->m_Names =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Name*, 4ull>);
        ...
        {
            if (!readName(__element__->m_Name))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!read(token_SCOPE, __element__->m_SCOPE))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readClass(Class*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_CLASS, token_STRUCT}, __element__->m_CLASS))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_PAREN_START)
        {
            ...
            consume();
            if (!readAssignExpression(__element__->m_MetaClassConstructionExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            consume();
            if (!read(token_PAREN_START, __element__->m_PAREN_START0))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            consume();
            __element__->m_BaseClasses =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::BaseClass*, 4ull>);
            phantom::lang::ast::BaseClass* temp66 = nullptr;
            if (!readBaseClass(temp66))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_Members == nullptr)
                    __element__->m_Members =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Member*, 4ull>);
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                if (__element__->m_MethodSpecifiers == nullptr)
                    __element__->m_MethodSpecifiers =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::MethodSpecifier*, 4ull>);
    ...
    bool readAccessSpecifier(AccessSpecifier*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_PUBLIC, token_PROTECTED, token_PRIVATE}, __element__->m_PUBLIC))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readFieldOverride(FieldOverride*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_DEFAULT, __element__->m_DEFAULT))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readMember(Member*& output)
    {
        ...
        case token_BRACKET_START:
        {
            if (!readMemberWithMetaOrAnnotation(__element__->m_MemberWithMetaOrAnnotation))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readBasicMember(__element__->m_BasicMember))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readMemberWithMetaOrAnnotation(Member*& output)
    {
        ...
        if (!readMetaOrAnnotation(temp72))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        __element__->m_MetaOrAnnotations =
        PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::MetaOrAnnotation*, 4ull>);
        __element__->m_MetaOrAnnotations->push_back(temp72);
        while (!endOfFile())
        {
            beginTry();
            readMetaOrAnnotation(temp72);
            if (endTry())
            {
                __element__->m_MetaOrAnnotations->push_back(temp72);
            }
        ...
        if (!readMember(__element__->m_Member))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readBasicMemberWithMetaOrAnnotation(Member*& output)
    {
        ...
        if (!readMetaOrAnnotation(temp73))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readBasicMember(Member*& output)
    {
        ...
        case token_PRIVATE:
        {
            if (!readAccessSpecifier(__element__->m_AccessSpecifier))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_VIRTUAL:
        {
            if (lookahead(token_VIRTUAL))
            {
                ...
                {
                    if (!readDestructor(__element__->m_Destructor))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                ...
                {
                    if (!readMethod(__element__->m_Method))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
            ...
            {
                if (!readMethod(__element__->m_Method0))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
        ...
        case token_OPERATOR:
        {
            if (!readConversionFunction(__element__->m_ConversionFunction))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_COMPL:
        {
            if (!readDestructor(__element__->m_Destructor0))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_FRIEND:
        {
            if (!readFriend(__element__->m_Friend))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_BRACKET_START:
        {
            if (!readBasicMemberWithMetaOrAnnotation(__element__->m_BasicMemberWithMetaOrAnnotation))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readStatementOrCase(Statement*& output)
    {
        ...
        case token_CASE:
        {
            if (!readCaseStatement(__element__->m_CaseStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_DEFAULT:
        {
            if (!readDefaultStatement(__element__->m_DefaultStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!readStatement(__element__->m_Statement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readIfOrWhileLocalVariableDecl(IfOrWhileLocalVariableDecl*& output)
    {
        ...
        if (!read(token_ASSIGN, temp74))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readAssignExpressionOrInitializerList(__element__->m_Expression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readIfStatement(Statement*& output)
    {
        ...
        if (!readIfOrWhileCondition(__element__->m_Condition))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (!readStatement(__element__->m_Then))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        {
            consume();
            if (!readStatement(__element__->m_Else))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readSwitchStatement(Statement*& output)
    {
        ...
        __element__->m_StatementOrCases =
        PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Statement*, 4ull>);
        phantom::lang::ast::Statement* temp76 = nullptr;
        if (!readStatementOrCase(temp76))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readDoWhileStatement(Statement*& output)
    {
        ...
        if (!readBlockStatement(__element__->m_BlockStatement))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readStatement(Statement*& output)
    {
        ...
        case token_IF:
        {
            if (!readIfStatement(__element__->m_IfStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_FOR:
        {
            if (!readForStatement(__element__->m_ForStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_SWITCH:
        {
            if (!readSwitchStatement(__element__->m_SwitchStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_WHILE:
        {
            if (!readWhileStatement(__element__->m_WhileStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ASSERT:
        {
            if (!readAssertStatement(__element__->m_AssertStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_BREAK:
        {
            if (!readBreakStatement(__element__->m_BreakStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_CONTINUE:
        {
            if (!readContinueStatement(__element__->m_ContinueStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_DO:
        {
            if (!readDoWhileStatement(__element__->m_DoWhileStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_RETURN:
        {
            if (!readReturnStatement(__element__->m_ReturnStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_GOTO:
        {
            if (!readGotoStatement(__element__->m_GotoStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_TYPEDEF:
        {
            if (!readBlockDeclaration(__element__->m_BlockDeclaration))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ATAT:
        {
            if (!readMixinStatement(__element__->m_MixinStatement))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        default:
            ...
            else
            {
                ...
                {
                    if (!readExpressionStatement(__element__->m_ExpressionStatement))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
    ...
    bool readMixinStatement(MixinStatement*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_Expressions =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Expression*, 4ull>);
            __element__->m_Expressions->push_back(temp81);
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                consume();
                phantom::lang::ast::Expression* temp82 = nullptr;
                if (!readExpression(temp82))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readAutoLocalVariableDecl(LocalVariableDecl*& output)
    {
        ...
        __element__->m_AutoDeclarators =
        PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::AutoDeclarator*, 4ull>);
        phantom::lang::ast::AutoDeclarator* temp94 = nullptr;
        if (!readAutoDeclarator(temp94))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLocalVariableDecl(LocalVariableDecl*& output)
    {
        ...
        {
            if (!readAutoLocalVariableDecl(__element__->m_AutoLocalVariableDecl))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readExplicitLocalVariableDecl(__element__->m_ExplicitLocalVariableDecl))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readLocalVariableStatement(Statement*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!readLocalVariableDecl(__element__->m_LocalVariableDecl))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readExpression(Expression*& output)
    {
        ...
        bool         __reductible__ = true;
        if (!readAssignExpression(__element__->m_Expression_AssignExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_COMMA)
        {
            __reductible__ = false;
            consume();
            if (!readExpression(__element__->m_Expression_Expression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readAssignExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readConditionalExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (lookahead(token_GT))
        {
            ...
            if (lookahead(token_GT))
            {
                ...
                if (lookahead(token_ASSIGN))
                {
                    __reductible__ = false;
                    __element__->m_RightShiftAssign =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<spell::any, 4ull>)(3);
                    if (!read(token_GT, (*__element__->m_RightShiftAssign)[0]))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                    ...
                    if (!readContiguous(token_GT, (*__element__->m_RightShiftAssign)[1]))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                    }
                    if (!readContiguous(token_ASSIGN, (*__element__->m_RightShiftAssign)[2]))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                    }
                    if (!readAssignExpression(__element__->m_RightShiftAssign_RightExpression))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                ...
                else
                {
                    ...
                    if (!readShiftExpression(__element__->m_RightShift_RightExpression))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
            ...
            else
            {
                ...
                if (!readAddExpression(__element__->m_Greater_RightExpression))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
        ...
        else
        {
            ...
            case token_ASS_XOR:
            {
                ...
                consume();
                __reductible__ = false;
                if (!readAssignExpression(__element__->m_RightExpression))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
    ...
    bool readConditionalExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readLogicalOrExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (token() == token_QUESTION)
        {
            __reductible__ = false;
            consume();
            if (!readExpression(__element__->m_Then))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            ...
            if (!readExpression(__element__->m_Else))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readLogicalOrExpressionRight(LogicalOrExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_LOG_OR, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readLogicalAndExpression(__element__->m_RightExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLogicalOrExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readLogicalAndExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_LogicalOrExpressionRights == nullptr)
                    __element__->m_LogicalOrExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::LogicalOrExpressionRight*, 4ull>);
    ...
    bool readLogicalAndExpressionRight(LogicalAndExpressionRight*& output)
    {
        ...
        bool                        __reductible__ = true;
        if (!read(token_LOG_AND, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLogicalAndExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readBinOrExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_LogicalAndExpressionRights == nullptr)
                    __element__->m_LogicalAndExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::LogicalAndExpressionRight*, 4ull>);
    ...
    bool readBinOrExpressionRight(BinOrExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_BIN_OR, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readXOrExpression(__element__->m_RightExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readBinOrExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readXOrExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_BinOrExpressionRights == nullptr)
                    __element__->m_BinOrExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::BinOrExpressionRight*, 4ull>);
    ...
    bool readXOrExpressionRight(XOrExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_XOR, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readBinAndExpression(__element__->m_RightExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readXOrExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readBinAndExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_XOrExpressionRights == nullptr)
                    __element__->m_XOrExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::XOrExpressionRight*, 4ull>);
    ...
    bool readBinAndExpressionRight(BinAndExpressionRight*& output)
    {
        ...
        bool                    __reductible__ = true;
        if (!read(token_BIN_AND, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readBinAndExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readEqualityExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_BinAndExpressionRights == nullptr)
                    __element__->m_BinAndExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::BinAndExpressionRight*, 4ull>);
    ...
    bool readEqualityExpressionRight(EqualityExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_EQ, token_NE}, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readRelationalExpression(__element__->m_RightExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readEqualityExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readRelationalExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_EqualityExpressionRights == nullptr)
                    __element__->m_EqualityExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::EqualityExpressionRight*, 4ull>);
    ...
    bool readRelationalExpressionRight(RelationalExpressionRight*& output)
    {
        ...
        if (lookahead(token_GT) && lookahead(token_GT))
        {
            ...
            if (!read(token_GT, (*__element__->m_OpMul)[0]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!readContiguous(token_GT, (*__element__->m_OpMul)[1]))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
            }
            if (!readShiftExpression(__element__->m_RightExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!read({token_GT, token_GE, token_LE, token_LT, token_EQ, token_NE}, __element__->m_Op))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readRelationalExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readShiftExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_RelationalExpressionRights == nullptr)
                    __element__->m_RelationalExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::RelationalExpressionRight*, 4ull>);
    ...
    bool readShiftExpressionRight(ShiftExpressionRight*& output)
    {
        ...
        if (lookahead(token_GT))
        {
            if (lookahead(token_GE))
            {
                ...
                if (!readContiguous(token_GE, (*__element__->m_OpMul)[1]))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
                }
                if (!readAddExpression(__element__->m_RightExpression))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            else
            {
                ...
                {
                    if (!read(token_GT, __element__->m_Op))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
        ...
        {
            if (!read(token_SHL, __element__->m_Op))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readShiftExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readAddExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_ShiftExpressionRights == nullptr)
                    __element__->m_ShiftExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::ShiftExpressionRight*, 4ull>);
    ...
    bool readAddExpressionRight(AddExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_PLUS, token_MINUS}, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        }
        if (!readMulExpression(__element__->m_RightExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readAddExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readMulExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_AddExpressionRights == nullptr)
                    __element__->m_AddExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::AddExpressionRight*, 4ull>);
    ...
    bool readMulExpressionRight(MulExpressionRight*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_MUL, token_DIV, token_MOD}, __element__->m_Op))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readMulExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readUnaryExpression(__element__->m_LeftExpression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_MulExpressionRights == nullptr)
                    __element__->m_MulExpressionRights = PHANTOM_LANG_CPPLITEGRAMMAR_NEW(
                    phantom::SmallVector<phantom::lang::ast::MulExpressionRight*, 4ull>);
    ...
    bool readSpecialCastExpression(SpecialCastExpression*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_REINTERPRET_CAST, token_STATIC_CAST, token_CONST_CAST}, __element__->m_CastKind))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readUnaryExpression(Expression*& output)
    {
        ...
        {
            __reductible__ = false;
            if (!read({token_BIN_AND, token_INC, token_DEC, token_MUL, token_PLUS, token_MINUS, token_NOT, token_COMPL},
                      __element__->m_Op))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
            ...
            if (!readUnaryExpression(__element__->m_Expression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readInitializerList(Expression*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_AssignExpressionOrInitializerLists =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Expression*, 4ull>);
            ...
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                ...
                if (!readAssignExpressionOrInitializerList(temp111))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp110);
        if (!read(token_BLOCK_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readCallList(CallList*& output)
    {
        ...
        if (endTry())
        {
            ...
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                ...
                if (!readAssignExpressionOrInitializerList(temp113))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp112);
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readKeywordExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!read(token_THIS, __element__->m_Keyword))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readPostFixExpression(Expression*& output)
    {
        ...
        Expression** __reduction__ = (Expression**)&__element__;
        bool         __reductible__ = true;
        if (!readPrimaryExpression(__element__->m_Expression))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        while (!endOfFile())
        {
            ...
            if (endTry())
            {
                ...
                if (__element__->m_PostFixEnds == nullptr)
                    __element__->m_PostFixEnds =
                    PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::PostFixEnd*, 4ull>);
    ...
    bool readPostFixEnd(PostFixEnd*& output)
    {
        ...
        case token_BRACKET_START:
        {
            if (!readArrayAccess(__element__->m_ArrayAccess))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            __reductible__ = false;
            if (!read({token_DOT, token_ARROW, token_SCOPE}, __element__->m_DOT))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ELLIPSE:
        {
            if (!read(token_ELLIPSE, __element__->m_ELLIPSE))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        break;
        default:
            if (!read({token_INC, token_DEC}, __element__->m_INC))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readTypeTraitBinary(Expression*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_IS_SAME, __element__->m_IS_SAME))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
        ...
        if (!readType(__element__->m_Type0))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readAssertStatement(Statement*& output)
    {
        ...
        if (token() == token_COMMA)
        {
            ...
            if (endTry())
            {
                __element__->m_AssignExpressions =
                PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::Expression*, 4ull>);
                ...
                while (token(token_COMMA, m_TokenPointer + 0))
                {
                    ...
                    if (!readAssignExpression(temp117))
                    {
                        PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                        output = nullptr;
                        return false;
                ...
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp116);
        }
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
    ...
    bool readBreakStatement(Statement*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_BREAK, __element__->m_BREAK))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readContinueStatement(Statement*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read(token_CONTINUE, __element__->m_CONTINUE))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readSizeofExpression(Expression*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_SIZEOF, token_ALIGNOF}, __element__->m_SIZEOF))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readTypeofExpression(Expression*& output)
    {
        ...
        auto pos_begin = m_Tokens.back().location.begin;
        output = __element__;
        if (!read({token_TYPEOF, token_CLASSOF, token_ENUMOF, token_UNIONOF}, __element__->m_TYPEOF))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
            return false;
    ...
    bool readLambdaCapture(LambdaCapture*& output)
    {
        ...
        case token_BIN_AND:
        {
            if (!read(token_BIN_AND, __element__->m_BIN_AND))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_THIS:
        {
            if (!read(token_THIS, __element__->m_THIS))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
    ...
    bool readLambdaExpression(LambdaExpression*& output)
    {
        ...
        if (endTry())
        {
            __element__->m_LambdaCaptures =
            PHANTOM_LANG_CPPLITEGRAMMAR_NEW(phantom::SmallVector<phantom::lang::ast::LambdaCapture*, 4ull>);
            __element__->m_LambdaCaptures->push_back(temp119);
            while (token(token_COMMA, m_TokenPointer + 0))
            {
                consume();
                phantom::lang::ast::LambdaCapture* temp120 = nullptr;
                if (!readLambdaCapture(temp120))
                {
                    PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                    output = nullptr;
                    return false;
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp119);
        if (!read(token_BRACKET_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
        ...
        if (endTry())
        {
            ...
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(temp122);
        if (!read(token_PAREN_END))
        {
            PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
            output = nullptr;
    ...
    bool readPrimaryExpression(Expression*& output)
    {
        ...
        case token_THIS:
        {
            if (!readKeywordExpression(__element__->m_KeywordExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_ALIGNOF:
        {
            if (!readSizeofExpression(__element__->m_SizeofExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_UNIONOF:
        {
            if (!readTypeofExpression(__element__->m_TypeofExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_NULLPTR:
        {
            if (!readNullptrExpression(__element__->m_NullptrExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_PAREN_START:
        {
            if (!readCStyleCastExpression(__element__->m_CStyleCastExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_IS_SAME:
        {
            if (!readTypeTraitBinary(__element__->m_TypeTraitBinary))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readStringLiteralChain(__element__->m_StringLiteralChain))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readSpecialCastExpression(__element__->m_SpecialCastExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        {
            if (!readFunctionPtrExpression(__element__->m_FunctionPtrExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_VOID:
        {
            if (!readFundamentalTypeFunctionCast(__element__->m_FundamentalTypeFunctionCast))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        case token_BRACKET_START:
        {
            if (!readLambdaExpression(__element__->m_LambdaExpression))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
                output = nullptr;
                return false;
        ...
        default:
            if (!read({token_INT_VALUE, token_UINT_VALUE, token_LONG_VALUE, token_ULONG_VALUE, token_LONGLONG_VALUE,
                       token_ULONGLONG_VALUE, token_BOOL_VALUE, token_CHAR_LIT, token_FLOAT_VALUE, token_DOUBLE_VALUE,
                       token_HEX_VALUE},
                      __element__->m_INT_VALUE))
            {
                PHANTOM_LANG_CPPLITEGRAMMAR_DELETE(__element__);
...
CppLiteGrammar::CppLiteGrammar(Allocator a_Allocator) : m_Allocator(a_Allocator)
{
...
ast::Source* CppLiteGrammar::parseSource(char const* in, size_t size, ErrorDelegate e)
{
    ...
    if (e)
        _private->m_ErrorDelegate = e;
    else
        _private->m_ErrorDelegate = &ast::CppLiteGrammarPrivate::defaultErrorDelegate;
    if (_private->m_Lexer.begin(in, size) != spell::Lexer::e_Status_Ready)
        return nullptr;
    _private->consume(); // consumer first token
    if (_private->m_Lexer.getStatus() == spell::Lexer::e_Status_Error)
        return nullptr;
