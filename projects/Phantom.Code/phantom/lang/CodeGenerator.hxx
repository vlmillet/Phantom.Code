...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("CodeGenerator")
        ...
        .public_()
            ...
            .end()
            .constructor<void(int)>()({"a_uiPassCount"})
            ...
            .method<bool(StringView, StringView&) const>("getOption", &_::getOption)({"_option","_value"})
            .method<Module*() const>("getModule", &_::getModule)
            .method<void()>("outdate", &_::outdate)
            .method<bool() const>("isOutdated", &_::isOutdated)
            .method<bool(Method*, void*, void**, void*) const>("invoke", &_::invoke)({"a_pMethod","a_pObject","a_ppArgs","a_pRet"})
            .method<bool(Subroutine*, void**, void*) const>("call", &_::call)({"a_pSubroutine","a_ppArgs","a_pRet"})
            .method<::phantom::lang::ExecutionContext *() const, pure_virtual>("createExecutionContext", &_::createExecutionContext)
            .method<void(ExecutionContext*) const, pure_virtual>("destroyExecutionContext", &_::destroyExecutionContext)({"a_pContext"})
        
        .protected_()
            .method<::phantom::lang::DebugInformation *(), virtual_>("createDebugInformation", &_::createDebugInformation)
            .method<void(DebugInformation*), virtual_>("destroyDebugInformation", &_::destroyDebugInformation)({"a_pDebugInformationHandler"})
        
        .protected_()
            .method<void(), virtual_>("begin", &_::begin)
            .method<void(), virtual_>("abort", &_::abort)
            .method<void(), virtual_>("end", &_::end)
            .method<::phantom::lang::CodeGenerator::Error(uint), pure_virtual>("compile", &_::compile)({"a_uiPass"})
