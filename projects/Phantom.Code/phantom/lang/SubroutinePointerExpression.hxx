...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("SubroutinePointerExpression")
        ...
        .public_()
            .constructor<void(Source*, Subroutine*)>()({"a_pSource","a_pSubroutine"})
        ...
        .protected_()
            .method<::phantom::lang::SubroutinePointerExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
