...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("conversions")
        ...
        {
            this_()
            .constructor<void(LanguageElement*, ConversionVal, ConversionVal)>()
            .method<void(const void*, void*) const, pure_virtual>("apply", &_::apply)
            .method<::phantom::lang::Conversion *(LanguageElement*) const, pure_virtual>("clone", &_::clone)
            .method<int(const Conversion&) const, virtual_>("compare", &_::compare)
            .method<::phantom::lang::Expression *(Semantic*, Expression*) const, pure_virtual>("convert", &_::convert)
        ...
        PHANTOM_STRUCT(TemplateDependantConversion)
        {
            ...
            .method<::phantom::lang::Conversion *(LanguageElement*) const, virtual_|override_>("clone", &_::clone)
            .method<int(const Conversion&) const, virtual_>("compare", &_::compare)
        ...
        .public_()
            ...
            .constructor<void()>()
            .constructor<void(ConversionResults&&)>()
            .constructor<void(const ConversionResults&)>()
            .method<ConversionResults&(ConversionResults&&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<ConversionResults&(const ConversionResults&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<int(const ConversionResults&) const>("compare", &_::compare)
            .method<void(Conversion*)>("push_back", &_::push_back)
            .method<bool() const>("hasNull", &_::hasNull)
            .method<Conversion*(size_t*)>("takeBest", &_::takeBest)
            .method<Conversion* const&(size_t) const>("operator[]", &_::operator[])
            ...
            .method<void(Source*)>("destroy", &_::destroy)
