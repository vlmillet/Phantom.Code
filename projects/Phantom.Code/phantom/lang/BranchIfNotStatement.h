...
namespace lang
{
/// \brief  Represents a "branch if not" instruction.
class PHANTOM_EXPORT_PHANTOM_CODE BranchIfNotStatement : public BranchStatement
{
...
public:
    ...
    BranchIfNotStatement(Expression* a_pExpression, Label* a_pLabel);

    void initialize();

    BranchIfNotStatement* asBranchIfNotStatement() const override { return (BranchIfNotStatement*)this; }
