...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Interpreter")
        ...
        PHANTOM_CLASS(Interpreter)
        {
            this_()
        .public_()
            .method<bool(ExecutionContext&, Subroutine*, void**, size_t)>("call", &_::call)({"a_Context","a_pSubroutine","a_ppArgs","a_uiCount"})
            .method<void(Statement*)>("setNextStatement", &_::setNextStatement)({"a_pStatement"})
            ...
            .method<void(void*)>("setDefaultThisPointer", &_::setDefaultThisPointer)({"a_pPointer"})
        ...
        .public_()
            ...
            .method<bool(Subroutine*, void**, size_t), virtual_|override_>("call", &_::call)({"a_pSubroutine","a_ppArgs","a_uiCount"})
            .method<void(Statement*), virtual_|override_>("setNextStatement", &_::setNextStatement)({"a_pStatement"})
            ...
            .method<byte*(LocalVariable*) const, virtual_|override_>("addressOf", &_::addressOf)({"a_pLocalVariable"})
            ;
        }
