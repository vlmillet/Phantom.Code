...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("OwnerGuard")
        ...
        {
            this_()
            .PHANTOM_T constructor<void(T*)>()({"a_pElem"})
            ...
            .PHANTOM_T method<OwnerGuard<T>&(T*)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"a_pOther"})
            ;
        }
        PHANTOM_STRUCT_T((class), (Ts), OwnersGuard)
        {
            ...
            .PHANTOM_T constructor<void(const Ts&)>()({"list"})
            .PHANTOM_T method<void()>("cancel", &_::cancel)
            .PHANTOM_T method<void(const typename Ts::value_type &)>("push_back", &_::push_back)({"a_Val"})
