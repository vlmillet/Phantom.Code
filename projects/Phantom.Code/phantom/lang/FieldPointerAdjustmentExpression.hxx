...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("FieldPointerAdjustmentExpression")
        ...
        .public_()
            .constructor<void(Type*, Expression*, ptrdiff_t)>()({"a_pOutputPointerType","a_pPointerExpression","a_iOffset"})
            ...
            .method<::phantom::lang::FieldPointerAdjustmentExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
