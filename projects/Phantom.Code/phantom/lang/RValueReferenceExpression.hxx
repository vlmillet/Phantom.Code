...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("RValueReferenceExpression")
        ...
        .public_()
            ...
            .method<RValueReferenceExpression*(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
            .method<void(ExecutionContext&) const, virtual_|override_>("load", &_::load)({"a_Context"})
