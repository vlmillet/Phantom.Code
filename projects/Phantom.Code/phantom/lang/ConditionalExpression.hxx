...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("ConditionalExpression")
        ...
        .public_()
            .constructor<void(Expression*, Expression*, Expression*)>()
            .method<void()>("initialize", &_::initialize)
            .method<void(ExecutionContext&) const, virtual_>("eval", &_::eval)
            .method<::phantom::lang::ConditionalExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)
