...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("BuiltInConversionExpression")
        ...
        .public_()
            .constructor<void(Expression*, Conversion*, CastKind)>()({"a_pInputExpression","a_pConversion","a_eConversionType"})
            ...
            .method<::phantom::lang::BuiltInConversionExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
