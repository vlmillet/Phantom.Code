...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("InitializerListExpression")
        ...
        .public_()
            .constructor<void(InitializerListType*, ExpressionsView)>()
            .constructor<void(Class*, ExpressionsView)>()
            ...
            .method<::phantom::lang::InitializerListExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)
