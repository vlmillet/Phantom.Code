...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("ConstructorCallExpression")
        ...
        .public_()
            .constructor<void(Constructor*)>()({"a_pConstructor"})
            .constructor<void(Constructor*, ExpressionsView)>()({"a_pConstructor","a_Arguments"})
            .constructor<void(Constructor*, Expression*)>()({"a_pConstructor","a_pArgument"})
            .method<void()>("initialize", &_::initialize)
            .method<void(ExecutionContext&) const, virtual_>("eval", &_::eval)({"a_Context"})
            .method<::phantom::lang::ConstructorCallExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
