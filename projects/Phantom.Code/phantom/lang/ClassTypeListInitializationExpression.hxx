...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("ClassTypeListInitializationExpression")
        ...
        .public_()
            .constructor<void(ClassType*, ExpressionsView)>()({"a_pClassType","a_Expressions"})
            ...
            .method<::phantom::lang::ClassTypeListInitializationExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
