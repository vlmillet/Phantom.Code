...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("StructureExpression")
        ...
        .public_()
            .constructor<void(Structure*, const Fields&, ExpressionsView)>()({"a_pStructureType","a_Fields","a_Values"})
            ...
            .method<::phantom::lang::StructureExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
