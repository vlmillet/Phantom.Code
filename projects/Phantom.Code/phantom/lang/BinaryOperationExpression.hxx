...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("BinaryOperationExpression")
        ...
        .public_()
            .constructor<void(StringView, Expression*, Expression*)>()
            .constructor<void(Type*, StringView, Expression*, Expression*)>()
            ...
            .method<::phantom::lang::BinaryOperationExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)
