...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("MethodPointerAdjustmentExpression")
        ...
        .public_()
            .constructor<void(MethodPointer*, Expression*, ptrdiff_t)>()({"a_pOutputPointerType","a_pPointerExpression","a_iOffset"})
            ...
            .method<::phantom::lang::MethodPointerAdjustmentExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
