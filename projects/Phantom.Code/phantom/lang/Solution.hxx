...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Solution")
        ...
        .public_()
            ...
            .method<Project*(StringView) const>("getProjectFromName", &_::getProjectFromName)({"a_Name"})
            .method<Project*(StringView) const>("getProjectFromPath", &_::getProjectFromPath)({"a_Path"})
            .method<Project*(Module*) const>("getProjectFromModule", &_::getProjectFromModule)({"a_pModule"})
            .method<Project*(StringView, Module*)>("addProject", &_::addProject)({"a_Path","a_pExtendedNativeModule"})["nullptr"]
            .method<Project*(StringView, StringView, Module*)>("addProject", &_::addProject)({"a_Name","a_Path","a_pNativeModule"})
            .method<void(StringView)>("removeProject", &_::removeProject)({"a_Path"})
