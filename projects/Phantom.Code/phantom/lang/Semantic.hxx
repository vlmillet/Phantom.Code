...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Semantic")
        ...
        .public_()
            ...
            .method<void(ParameterPackExpressionExpansion*, VisitorData), virtual_>("visit", &_::visit)({"a_pInput","a_Data"})
            ...
            .method<void(Signature*, TypesView, ConversionResults&, TemplateSubstitution&, LanguageElement*, UserDefinedFunctions)>("newImplicitConversionsWithArgDeductions", &_::newImplicitConversionsWithArgDeductions)({"a_pSignature","a_ArgTypes","a_Out","a_TemplateArgDeductions","a_pContextScope","a_ConversionAllowedUserDefinedFunctions"})
