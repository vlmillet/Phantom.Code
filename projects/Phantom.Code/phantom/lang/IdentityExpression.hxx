...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("IdentityExpression")
        ...
        .public_()
            .constructor<void(Type*, Expression*)>()
            ...
            .method<::phantom::lang::IdentityExpression *(LanguageElement*) const, virtual_|override_>("cloneImpl", &_::cloneImpl)
            ...
            .method<void(CastKind)>("setConversionKind", &_::setConversionKind)
