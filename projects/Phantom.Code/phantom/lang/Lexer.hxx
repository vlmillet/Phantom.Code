...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Lexer")
        ...
        PHANTOM_STRUCT(any)
        {
            ...
            .constructor<void(unsigned char)>()
            .constructor<void(int)>()
            .constructor<void(unsigned int)>()
            .constructor<void(short)>()
            .constructor<void(unsigned short)>()
            .constructor<void(long)>()
            .constructor<void(unsigned long)>()
            .constructor<void(long long)>()
            .constructor<void(unsigned long long)>()
            .constructor<void(double)>()
            .constructor<void(float)>()
            .constructor<void(bool)>()
            .constructor<void()>()
            .method<any&(const char*)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(char)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(unsigned char)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(int)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(unsigned int)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(short)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(unsigned short)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(long)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(unsigned long)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(long long)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(unsigned long long)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(double)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(float)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<any&(bool)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .method<bool() const>("hasValue", &_::hasValue)
            .method<bool(any&)>("as", &_::as)
            .method<bool(const char*&)>("as", &_::as)
            .method<bool(char&)>("as", &_::as)
            .method<bool(unsigned char&)>("as", &_::as)
            .method<bool(int&)>("as", &_::as)
            .method<bool(unsigned int&)>("as", &_::as)
            .method<bool(short&)>("as", &_::as)
            .method<bool(unsigned short&)>("as", &_::as)
            .method<bool(long&)>("as", &_::as)
            .method<bool(unsigned long&)>("as", &_::as)
            .method<bool(long long&)>("as", &_::as)
            .method<bool(unsigned long long&)>("as", &_::as)
            .method<bool(double&)>("as", &_::as)
            .method<bool(float&)>("as", &_::as)
            .method<bool(bool&)>("as", &_::as)
            .constructor<void(const any&)>()
            .method<any&(const any&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
        ...
        .protected_()
            ...
            .end()
            .struct_<adder>()
                .constructor<void(Lexer&)>()
                .method<adder&(RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(RuleType, int, const char*)>("operator()", &_::adder::operator())
                .method<adder&(RuleType, const char*)>("operator()", &_::adder::operator())
                .method<adder&(const char*, RuleType, const char*)>("operator()", &_::adder::operator())
                .method<adder&(const char*, RuleType, int, const char*)>("operator()", &_::adder::operator())
                .method<adder&(const char*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(char*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(bool*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(unsigned long*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(unsigned int*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(unsigned long long*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(long*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(int*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(long long*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(float*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(double*, RuleType, int)>("operator()", &_::adder::operator())
                .method<adder&(const char**, RuleType, int)>("operator()", &_::adder::operator())
            .end()
        ...
        .public_()
            .constructor<void()>()
            .constructor<void(Allocator)>()
            .enum_<EStatus>().values({
                {"e_Status_Ready",_::e_Status_Ready},
                {"e_Status_Error",_::e_Status_Error},
                {"e_Status_Finished",_::e_Status_Finished}})
            .end()
            .method<adder&(RuleType, int)>("addRule", &_::addRule)
            .method<adder&(RuleType, const char*)>("addRule", &_::addRule)
            .method<adder&(RuleType, int, const char*)>("addRule", &_::addRule)
            .method<adder&(const char*, RuleType, const char*)>("addRule", &_::addRule)
            .method<adder&(const char*, RuleType, int, const char*)>("addRule", &_::addRule)
            .method<adder&(const char*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(char*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(bool*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(unsigned long*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(unsigned int*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(unsigned long long*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(long*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(int*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(long long*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(float*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(double*, RuleType, int)>("addRule", &_::addRule)
            .method<adder&(const char**, RuleType, int)>("addRule", &_::addRule)
            .method<void(const char*)>("skip", &_::skip)
            .method<void(const char*, const char*)>("addPattern", &_::addPattern)
            .method<EStatus(const char*, size_t, const char*)>("begin", &_::begin)["nullptr"]
            .method<void()>("end", &_::end)
            .method<EStatus(Token&)>("next", &_::next)
...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Lexer")
        ...
        {
            this_()
            .constructor<void(unsigned long), explicit_>()
        ...
        PHANTOM_STRUCT(base_iterator_type)
        {
            this_()
            .constructor<void(), default_>()
            .constructor<void(const char*&, const char*)>()
            ...
            .method<bool(base_iterator_type const&) const>("operator==", &_::operator==)
            .method<bool(base_iterator_type const&) const>("operator!=", &_::operator!=)
            .field("end", &_::end)
            ;
        }
...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Lexer")
        ...
        .public_()
            ...
            .method<char const&() const>("operator*", &_::operator*)
            .method<char const*() const>("operator->", &_::operator->)
            .method<bool(position_iterator const&) const>("operator==", &_::operator==)
            .method<bool(position_iterator const&) const>("operator!=", &_::operator!=)
            .method<bool(position_iterator const&) const>("operator<", &_::operator<)
            .method<bool(position_iterator const&) const>("operator>", &_::operator>)
            .method<int() const>("get_line", &_::get_line)
            .method<int() const>("get_col", &_::get_col)
            .method<ptrdiff_t(position_iterator) const>("operator-", &_::operator-)
...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Lexer")
        ...
        PHANTOM_STRUCT(LexerPrivate)
        {
            ...
            .constructor<void(::spell::Lexer::Allocator)>()
            .method<const char*(const char*, size_t)>("addOrGetString", &_::addOrGetString)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("defaultAction", &_::defaultAction)
            .method<void(::spell::Token::EError)>("error", &_::error)
            .method<void(::spell::Token::EWarning)>("warning", &_::warning)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_bool", &_::parse_bool)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_hex", &_::parse_hex)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_double", &_::parse_double)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_float", &_::parse_float)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_uint", &_::parse_uint)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_ulong", &_::parse_ulong)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_ulonglong", &_::parse_ulonglong)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_int", &_::parse_int)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_long", &_::parse_long)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_longlong", &_::parse_longlong)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_char", &_::parse_char)
            .staticMethod<void(LexerPrivate&, position_iterator const&, position_iterator const&)>("parse_cstring", &_::parse_cstring)
            ;
        }
