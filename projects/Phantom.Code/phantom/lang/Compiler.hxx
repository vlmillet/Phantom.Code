...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Compiler")
        ...
        .public_()
            ...
            .method<CompiledSources(StringView)>("listProjectCompiledSourcesAt", &_::listProjectCompiledSourcesAt)
            .method<CompiledSources(BuildSessionId, StringView)>("listProjectCompiledSources", &_::listProjectCompiledSources)
            .method<String(BuildSessionId, StringView) const>("findProjectPath", &_::findProjectPath)
